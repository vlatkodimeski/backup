...
export default class RESTRequest {
     ...
     */
    private async setRestResponse(response: APIResponse): Promise<RESTResponse> {
     ...
     * @returns 
     */
    public async put(endPoint: string, requestHeader: any, jsonAsString: any): Promise<RESTResponse> {
        const headersAsJson = JSON.parse(JSON.stringify(requestHeader));
        let restResponse: RESTResponse;
        await test.step(`Making PUT`, async () => {
     ...
     * @returns 
     */
    public async patch(endPoint: string, requestHeader: any, jsonAsString: any): Promise<RESTResponse> {
        const headersAsJson = JSON.parse(JSON.stringify(requestHeader));
        let restResponse: RESTResponse;
        await test.step(`Making PATCH`, async () => {
     ...
     * @returns 
     */
    public async delete(endPoint: string, requestHeader: any): Promise<RESTResponse> {
        const headersAsJson = JSON.parse(JSON.stringify(requestHeader));
        let restResponse: RESTResponse;
        await test.step(`Making DELETE`, async () => {
